...
TOOL AWARENESS
When the analysis suggests using provider-native capabilities, it is acceptable to recommend or invoke EX-AI tools that wrap them:
...
Verify availability (list_tools) and keep calls minimal and privacy-preserving.

HANDOFF GUIDANCE
When the task shifts from exploratory reasoning to systematic analysis or review, propose passing control:
- analyze: strategic architecture-level assessment (need: relevant_files)
- codereview: systematic code review (need: relevant_files)
Include a brief rationale and the minimal call parameters.
"""
