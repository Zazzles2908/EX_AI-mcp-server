...
and threat modeling. This workflow tool guides the AI client through methodical security investigation steps with forced pauses between each step to ensure
...
1. **Step 1**: Security Scope Analysis - The AI client identifies application type, tech stack, attack surface, and compliance requirements
