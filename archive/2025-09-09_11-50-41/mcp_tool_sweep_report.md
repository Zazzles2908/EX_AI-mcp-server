...
[testgen step 1]
{
  ...
  "continuation_id": "9b5db092-b169-493f-940b-102d253b316c",
  "file_context": {
    "type": "reference_only",
...
[testgen step 2]
{
  ...
  "content": "Model 'auto' is not available. Available models: {}",
  "content_type": "text",
  "test_generation_status": {
    "files_checked": 1,
    "relevant_files": 1,
  ...
  "complete_test_generation": {
    "initial_request": "Start testgen: test",
    "steps_taken": 2,
    "files_examined": [
      "C:\\Project\\EX-AI-MCP-Server\\README.md"
    ],
    ...
    "relevant_context": [],
    "issues_found": [],
    "work_summary": "=== TESTGEN WORK SUMMARY ===\nTotal steps: 2\nFiles examined: 1\nRelevant files identified: 1\nMethods/
...
[truncated]
```
...
```text
Model 'kimi-k2-0905-preview' is not available. Available models: {}
```
