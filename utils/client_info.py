...
# Default friendly name when no match is found (must NOT be 'Claude' to avoid false positives)
DEFAULT_FRIENDLY_NAME = "MCP Client"
...
#         response = f"Hello from EX MCP Server to {client_name}!"
#     elif client_name == "Gemini":
#         response = f"Greetings {client_name}, welcome to EX MCP Server!"
#     else:
