...
# EX MCP Server - Code Quality Checks
...
echo "🔍 Running Code Quality Checks for EX MCP Server"
echo "================================================="
...
$RUFF check --fix --exclude test_simulation_files --exclude .venv

echo "🎨 Running black code formatting..."
$BLACK . --exclude="test_simulation_files/" --exclude=".venv/"

echo "📦 Running import sorting with isort..."
$ISORT . --skip-glob=".venv/*" --skip-glob="test_simulation_files/*"

echo "✅ Verifying all linting passes..."
$RUFF check --exclude test_simulation_files --exclude .venv
