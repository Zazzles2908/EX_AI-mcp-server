...
> **🔧 Fork Notice**: This is a fork of [BeehiveInnovations/zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server) specifically adapted for compatibility with [Auggie CLI](https://github.com/augmentcode/auggie) and rebranded as "Zazzles's Agent". All original functionality is preserved while adding streamlined integration with our local development workflows.
...
- **Getting Started**
  ...
  - [Auggie CLI Setup](#auggie-cli-integration) - Integration with Auggie and Zazzles's Agent
...
- **A second opinion** on complex architectural decisions - Zazzles's Agent Claude's thinking with perspectives from Gemini Pro, O3, or [dozens of other models via custom endpoints](docs/custom_models.md) ([`thinkdeep`](#2-thinkdeep---extended-reasoning-partner))
...
This fork provides seamless integration with [Auggie CLI](https://github.com/augmentcode/auggie) and [Zazzles's Agent](https://www.augmentcode.com/), enabling you to use all Zen MCP tools directly within Zazzles's Agent's development environment.
...
- **Works with Auggie CLI** - See AUGGIE_SETUP_FINAL.md for CLI integration and examples
...
# The file should contain at least one of these:
# KIMI_API_KEY=your-kimi-api-key-here       # Kimi (Moonshot)
# GLM_API_KEY=your-glm-api-key-here         # Zhipu GLM
# OPENROUTER_API_KEY=your-openrouter-key    # Optional: OpenRouter
# CUSTOM_API_URL=http://localhost:11434/v1  # Optional: local OpenAI-compatible API
# CUSTOM_MODEL_NAME=llama3.2                # Optional: local model name
...
Get a second opinion to Zazzles's Agent Claude's own extended thinking. Uses specialized thinking models to challenge assumptions, identify edge cases, and provide alternative perspectives.
